...
import 'package:date_world/features/address/domain/repositories/address_repository_interface.dart';
import 'package:date_world/features/address/domain/services/address_service.dart';
...
import 'package:date_world/features/auth/domain/repositories/auth_repository.dart';
import 'package:date_world/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:date_world/features/auth/domain/services/auth_service.dart';
import 'package:date_world/features/auth/domain/services/auth_service_interface.dart';
import 'package:date_world/features/banner/controllers/banner_controller.dart';
import 'package:date_world/features/banner/domain/repositories/banner_repository.dart';
import 'package:date_world/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:date_world/features/banner/domain/services/banner_service.dart';
import 'package:date_world/features/banner/domain/services/banner_service_interface.dart';
import 'package:date_world/features/brand/domain/repositories/brand_repo_interface.dart';
import 'package:date_world/features/brand/domain/repositories/brand_repository.dart';
import 'package:date_world/features/brand/domain/services/brand_service.dart';
import 'package:date_world/features/brand/domain/services/brand_service_interface.dart';
import 'package:date_world/features/cart/domain/repositories/cart_repository.dart';
import 'package:date_world/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:date_world/features/cart/domain/services/cart_service.dart';
import 'package:date_world/features/cart/domain/services/cart_service_interface.dart';
import 'package:date_world/features/category/domain/repositories/category_repo.dart';
import 'package:date_world/features/category/domain/repositories/category_repo_interface.dart';
import 'package:date_world/features/category/domain/services/category_service.dart';
import 'package:date_world/features/category/domain/services/category_service_interface.dart';
import 'package:date_world/features/chat/domain/repositories/chat_repository.dart';
import 'package:date_world/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:date_world/features/chat/domain/services/chat_service.dart';
...
import 'package:date_world/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:date_world/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:date_world/features/checkout/domain/services/checkout_service.dart';
...
import 'package:date_world/features/compare/domain/repositories/compare_repository.dart';
import 'package:date_world/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:date_world/features/compare/domain/services/compare_service.dart';
...
import 'package:date_world/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:date_world/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:date_world/features/contact_us/domain/services/contact_us_service.dart';
import 'package:date_world/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:date_world/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:date_world/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:date_world/features/coupon/domain/services/coupon_service.dart';
import 'package:date_world/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:date_world/features/address/domain/repositories/address_repository.dart';
...
import 'package:date_world/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:date_world/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:date_world/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:date_world/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:date_world/features/deal/domain/services/featured_deal_service.dart';
import 'package:date_world/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:date_world/features/deal/domain/services/flash_deal_service.dart';
import 'package:date_world/features/deal/domain/services/flash_deal_service_interface.dart';
import 'package:date_world/features/location/controllers/location_controller.dart';
import 'package:date_world/features/location/domain/repositories/location_repository.dart';
import 'package:date_world/features/location/domain/repositories/location_repository_interface.dart';
import 'package:date_world/features/location/domain/services/location_service.dart';
import 'package:date_world/features/location/domain/services/location_service_interface.dart';
...
import 'package:date_world/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
...
import 'package:date_world/features/notification/domain/repositories/notification_repository.dart';
import 'package:date_world/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:date_world/features/notification/domain/services/notification_service.dart';
...
import 'package:date_world/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:date_world/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:date_world/features/onboarding/domain/services/onboarding_service.dart';
...
import 'package:date_world/features/order/domain/repositories/order_repository.dart';
import 'package:date_world/features/order/domain/repositories/order_repository_interface.dart';
import 'package:date_world/features/order/domain/services/order_service.dart';
...
import 'package:date_world/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:date_world/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:date_world/features/order_details/domain/services/order_details_service.dart';
...
import 'package:date_world/features/product/domain/repositories/product_repository.dart';
import 'package:date_world/features/product/domain/repositories/product_repository_interface.dart';
import 'package:date_world/features/product/domain/repositories/seller_product_repository.dart';
import 'package:date_world/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:date_world/features/product/domain/services/product_service.dart';
import 'package:date_world/features/product/domain/services/product_service_interface.dart';
import 'package:date_world/features/product/domain/services/seller_product_service.dart';
import 'package:date_world/features/product/domain/services/seller_product_service_interface.dart';
import 'package:date_world/features/product_details/controllers/product_details_controller.dart';
import 'package:date_world/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:date_world/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:date_world/features/product_details/domain/services/product_details_service.dart';
...
import 'package:date_world/features/profile/domain/repositories/profile_repository.dart';
import 'package:date_world/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:date_world/features/profile/domain/services/profile_service.dart';
...
import 'package:date_world/features/refund/domain/repositories/refund_repository.dart';
import 'package:date_world/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:date_world/features/refund/domain/services/refund_service.dart';
...
import 'package:date_world/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:date_world/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:date_world/features/reorder/domain/services/re_order_service.dart';
...
import 'package:date_world/features/restock/domain/repositories/restock_repository.dart';
import 'package:date_world/features/restock/domain/repositories/restock_repository_interface.dart';
import 'package:date_world/features/restock/domain/services/restock_service.dart';
...
import 'package:date_world/features/review/domain/repositories/review_repository.dart';
import 'package:date_world/features/review/domain/repositories/review_repository_interface.dart';
import 'package:date_world/features/review/domain/services/review_service.dart';
import 'package:date_world/features/review/domain/services/review_service_interface.dart';
import 'package:date_world/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:date_world/features/search_product/domain/services/search_product_service.dart';
import 'package:date_world/features/search_product/domain/services/search_product_service_interface.dart';
import 'package:date_world/features/shipping/controllers/shipping_controller.dart';
import 'package:date_world/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:date_world/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:date_world/features/shipping/domain/services/shipping_service.dart';
import 'package:date_world/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:date_world/features/shop/domain/repositories/shop_repository.dart';
import 'package:date_world/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:date_world/features/shop/domain/services/shop_service.dart';
import 'package:date_world/features/shop/domain/services/shop_service_interface.dart';
import 'package:date_world/features/splash/controllers/splash_controller.dart';
import 'package:date_world/features/splash/domain/repositories/splash_repository.dart';
import 'package:date_world/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:date_world/features/splash/domain/services/splash_service.dart';
...
import 'package:date_world/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:date_world/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:date_world/features/support/domain/services/support_ticket_service.dart';
...
import 'package:date_world/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:date_world/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:date_world/features/wallet/domain/services/wallet_service.dart';
import 'package:date_world/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:date_world/features/wishlist/controllers/wishlist_controller.dart';
import 'package:date_world/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:date_world/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:date_world/features/wishlist/domain/services/wishlist_service.dart';
import 'package:date_world/features/wishlist/domain/services/wishlist_service_interface.dart';
